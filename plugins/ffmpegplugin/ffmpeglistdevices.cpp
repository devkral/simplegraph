...
void list_devices()
{
	...
	AVOutputFormat *output_device_format=NULL;
	...
	output_device_format = av_output_video_device_next(output_device_format);
	...
	input_device_format = av_input_audio_device_next(input_device_format);
	while (input_device_format!=NULL)
	{
	...
	output_device_format = av_output_audio_device_next(output_device_format);
	while (output_device_format!=NULL)
	{
